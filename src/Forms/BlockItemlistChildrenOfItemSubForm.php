...
final class BlockItemlistChildrenOfItemSubForm extends AbstractBlockItemlistSubForm implements BlockSubFormInterface
{
    public function getBlockForm(BlockForm $form, Block $block): void
    {
        ...
        if ($selectedItem !== null) :
            $datagroupChildren = $this->datagroupRepository->findAll(
